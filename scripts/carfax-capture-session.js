...
(async () => {
  ...
  try {
    ...
    // If a username/password form shows, we can prefill once
    ...
    console.log('>> If you see MFA/OTP, complete it now.');
    // Wait up to 3 minutes for the dashboard VIN field (after MFA)
    await page.waitForSelector(VIN_INPUT_SELECTOR, { timeout: 180000 });
